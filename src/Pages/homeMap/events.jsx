  ...
  useEffect(() => {
    ...
    const eventosEjemplo = [
      ...
      },
      {
        ...
        imagen:
          "https://upload.wikimedia.org/wikipedia/commons/a/aa/LOGO_ARE.jpg",
        ubicacion: {
          provincia: "Loja",
          canton: "Loja",
      ...
      },
      {
       ...
       {
        id: 8,
        titulo: "mejoramiento de la piscina olimpica",
        descripcion:
          "Espacio de diálogo ciudadano para definir prioridades de inversión municipal",
        fecha: "2024-06-15",
        hora: "18:00",
        ...
        ubicacion: {
          ...
          sector: "El cisne",
          direccion: "Plaza de la Independencia",
          lat: -4.005698191485551,
          lng:  -79.20510715622984
        },
        organizador: "MASS",
        tipo: "Evento Solidario",
        // Nuevos campos
      ...
      {
        id: 8,
        titulo: "Jornadas Medicas Gratuitas",
        descripcion:
          "Espacio de diálogo ciudadano para definir prioridades de inversión municipal",
        fecha: "2024-06-15",
        hora: "18:00",
        ...
        ubicacion: {
          ...
          sector: "El cisne",
          direccion: "Plaza de la Independencia",
          lat:  -4.364703883334179,
          lng:   -79.17684604673133
        },
        organizador: "MASS",
        tipo: "Evento Solidario",
        // Nuevos campos
          ...
          >
            <Card sx={{ maxWidth: 280, p: 1 }}>
              {/* {evento.imagen && (
                <CardMedia
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://via.placeholder.com/280x120?text=Sin+imagen";
                  }}
                />
              )} */}
              ...
              <Box>
                ...
                >
                  {evento.descripcion.length > 35
                    ? evento.descripcion.substring(0, 35) + "..."
                    : evento.descripcion}
                </Typography>
              </Box>
              ...
              <Typography variant="caption" display="block" sx={{ mt: 0.5 }}>
                Organiza:{" "}
                {evento.organizador.length > 35
                  ? evento.organizador.substring(0, 32)+"..."
                  : evento.organizador}
              </Typography>
            </Card>
          </Tooltip>
